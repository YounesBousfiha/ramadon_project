...
<body class="min-h-screen bg-deep-blue text-white">
<header class="container mx-auto px-4 py-6 flex justify-between items-center">
    <div class="flex items-center space-x-2">
        ...
        <span class="text-xl font-bold">RamadanJoy</span>
    </div>
    <nav>
        <ul class="flex space-x-4">
            <li><a href="/" class="hover:text-gold transition-colors">Home</a></li>
            <li><a href="/posts" class="hover:text-gold transition-colors">Posts</a></li>
            <li><a href="/recettes" class="hover:text-gold transition-colors">Recettes</a></li>
            <li><a href="/con" class="hover:text-gold transition-colors">Contact</a></li>
        </ul>
    </nav>
</header>
