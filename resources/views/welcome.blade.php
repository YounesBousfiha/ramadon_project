...
@section('statistique')
    <section class="container mx-auto px-4 py-16">
        <h2 class="text-3xl font-bold text-center mb-12">In Our Platform We Have</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white bg-opacity-10 p-6 rounded-lg text-center">
                <div class="text-gold mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p class="text-gray-300 text-xl font-semibold">{{ $totalPosts }}</p>
            </div>
            <div class="bg-white bg-opacity-10 p-6 rounded-lg text-center">
                <div class="text-gold mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 class="text-xl font-semibold mb-2">Total Recettes</h3>
                <p class="text-gray-300 text-xl font-semibold">{{  $totalRecettes }}</p>
            </div>
            <div class="bg-white bg-opacity-10 p-6 rounded-lg text-center">
                <div class="text-gold mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 class="text-xl font-semibold mb-2">Total Commentes</h3>
                <p class="text-gray-300 text-xl font-semibold">{{ $totalComments }}</p>
            </div>
        </div>
    </section>
@endsection
